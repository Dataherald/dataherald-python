...
from dataherald._types import Omit
...
def _get_open_connections(client: Dataherald | AsyncDataherald) -> int:
...
class TestDataherald:
    client = Dataherald(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: Dataherald) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Dataherald(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(DATAHERALD_BASE_URL="http://localhost:5000/from/env"):
            client = Dataherald(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(DATAHERALD_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                Dataherald(api_key=api_key, _strict_response_validation=True, environment="production")

            client = Dataherald(
                base_url=None, api_key=api_key, _strict_response_validation=True, environment="production"
            )
            assert str(client.base_url).startswith("https://api.dataherald.ai/")
    ...
    def test_base_url_trailing_slash(self, client: Dataherald) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Dataherald) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Dataherald) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Dataherald(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(object, dict(alias="alias", connection_uri="connection_uri")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/database-connections").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/database-connections").mock(side_effect=retry_handler)

        response = client.database_connections.with_raw_response.create(alias="alias", connection_uri="connection_uri")
    ...
    def test_omit_retry_count_header(
        self, client: Dataherald, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.database_connections.with_raw_response.create(
            alias="alias", connection_uri="connection_uri", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.database_connections.with_raw_response.create(
            alias="alias", connection_uri="connection_uri", extra_headers={"x-stainless-retry-count": "42"}
        )

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncDataherald:
    client = AsyncDataherald(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncDataherald) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(DATAHERALD_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncDataherald(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(DATAHERALD_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncDataherald(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: AsyncDataherald) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncDataherald) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncDataherald) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncDataherald(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.database_connections.with_raw_response.create(
            alias="alias", connection_uri="connection_uri"
        )
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncDataherald, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from dataherald._utils import asyncify
        from dataherald._base_client import get_platform 
